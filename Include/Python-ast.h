...
enum _stmt_kind {FunctionDef_kind=1, AsyncFunctionDef_kind=2, ClassDef_kind=3,
                  ...
                  Break_kind=24, Continue_kind=25, BokshEnd_kind=26};
struct _stmt {
...
#define BokshEnd(a0, a1, a2) _Py_BokshEnd(a0, a1, a2)
stmt_ty _Py_BokshEnd(int lineno, int col_offset, PyArena *arena);
